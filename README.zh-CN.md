...
4. 面向初入门博士生，关键术语会用即时 hover 解释，例如 `隐性改编`、`referent`、`level of analysis`、`回译`
5. HTML 表格默认使用中文表头、P0-P3 颜色或标签、`变量/量表`、`为什么重要` 和 `谁来处理` 列
6. 只有在用户明确要求时，才额外输出 Markdown、Excel 或单独的优化版问卷对照文件
