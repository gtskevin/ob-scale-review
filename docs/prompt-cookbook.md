# Survey Scale Review Prompt Cookbook
...
```text
Use $survey-scale-review to inspect this questionnaire file.
...
```text
/survey-scale-review inspect this questionnaire file.
First tell me whether the file has enough information for a full review.
...
```text
Use $survey-scale-review for a quick RA check.
...
```text
Use $survey-scale-review to do a full formal review of this questionnaire.
...
```text
Use $survey-scale-review to focus on adapted scales.
...
```text
Use $survey-scale-review to check all reverse-coded source items.
...
```text
Use $survey-scale-review to review the self-developed or highly adapted items.
...
```text
Use $survey-scale-review to create an optimized questionnaire comparison table
